...
// ── Trama japonesa — kanji grandes + hojas grandes ──
  ...
  return (
    <div className="min-h-screen flex flex-col relative" style={{
      ...
      <header className="relative z-10 flex justify-between items-center px-8 py-5 border-b border-white/5">
        <Image src="/logo.png" alt="kanbanbonsai" width={260} height={80} className="h-16 w-auto" priority />
      ...
      <section className="relative z-10 py-16 px-8">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Título + login en fila, centrados */}
      ...
      <footer className="relative z-10 border-t border-white/10 py-10 px-8">
        <div className="max-w-3xl mx-auto flex flex-col items-center gap-4 text-center">
          <Image src="/logo.png" alt="kanbanbonsai" width={200} height={60} className="h-12 w-auto opacity-50"/>
